...
@test "greeting-passthrough-ts-c8-default-help" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts test/fixtures/greeting-passthrough.ts --help
  save_and_compare_snapshot "greeting-passthrough-ts" c8-default-help "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-default-missing-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts test/fixtures/greeting-passthrough.ts
  save_and_compare_snapshot "greeting-passthrough-ts" c8-default-missing-args "$output"
  [ "$status" -eq 1 ]
}

@test "greeting-passthrough-ts-c8-default-valid-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts test/fixtures/greeting-passthrough.ts John
  save_and_compare_snapshot "greeting-passthrough-ts" c8-default-valid-args "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-deno-help" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts deno eval -- test/fixtures/greeting-passthrough.ts --help
  save_and_compare_snapshot "greeting-passthrough-ts" c8-deno-help "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-deno-missing-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts deno eval -- test/fixtures/greeting-passthrough.ts
  save_and_compare_snapshot "greeting-passthrough-ts" c8-deno-missing-args "$output"
  [ "$status" -eq 1 ]
}

@test "greeting-passthrough-ts-c8-deno-valid-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts deno eval -- test/fixtures/greeting-passthrough.ts John
  save_and_compare_snapshot "greeting-passthrough-ts" c8-deno-valid-args "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-tsx-help" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts tsx -e -- test/fixtures/greeting-passthrough.ts --help
  save_and_compare_snapshot "greeting-passthrough-ts" c8-tsx-help "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-tsx-missing-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts tsx -e -- test/fixtures/greeting-passthrough.ts
  save_and_compare_snapshot "greeting-passthrough-ts" c8-tsx-missing-args "$output"
  [ "$status" -eq 1 ]
}

@test "greeting-passthrough-ts-c8-tsx-valid-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts tsx -e -- test/fixtures/greeting-passthrough.ts John
  save_and_compare_snapshot "greeting-passthrough-ts" c8-tsx-valid-args "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-node-ts-help" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts node --experimental-strip-types --experimental-detect-module --disable-warning=MODULE_TYPELESS_PACKAGE_JSON --disable-warning=ExperimentalWarning -e -- test/fixtures/greeting-passthrough.ts --help
  save_and_compare_snapshot "greeting-passthrough-ts" c8-node-ts-help "$output"
  [ "$status" -eq 0 ]
}

@test "greeting-passthrough-ts-c8-node-ts-missing-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts node --experimental-strip-types --experimental-detect-module --disable-warning=MODULE_TYPELESS_PACKAGE_JSON --disable-warning=ExperimentalWarning -e -- test/fixtures/greeting-passthrough.ts
  save_and_compare_snapshot "greeting-passthrough-ts" c8-node-ts-missing-args "$output"
  [ "$status" -eq 1 ]
}

@test "greeting-passthrough-ts-c8-node-ts-valid-args" {
  run npx -s c8 --reporter=none --clean=false tsx ./src/bin/knevee.ts node --experimental-strip-types --experimental-detect-module --disable-warning=MODULE_TYPELESS_PACKAGE_JSON --disable-warning=ExperimentalWarning -e -- test/fixtures/greeting-passthrough.ts John
  save_and_compare_snapshot "greeting-passthrough-ts" c8-node-ts-valid-args "$output"
  [ "$status" -eq 0 ]
}
